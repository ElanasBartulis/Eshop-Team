    ...
    return (
        ...
        <div className="mt-4 space-y-6">
            ...
            <li key={item.productId} className="flex items-center gap-4">
                ...
                <div>
                <h3 className="text-sm text-gray-900">{item.productId.name}</h3>
                ...
                <button className="text-gray-600 transition hover:text-red-600" onClick={() => handleRemoveItem(item.productId)}>
